...
//Azure IoT Hub const
static const char* connectionString = "HostName=vtam-msft-IoTHub.azure-devices.net;DeviceId=MyTwinDevice;SharedAccessKey=COj537E5oo64z7fwcMQsER2ie7/8ykZPUuMHIrrlcHI=";
...
static int InitializeAzureIoTHub(ROS_Azure_IoT_Hub* iotHub)
{
    ...
    iotHub->deviceHandle = IoTHubDeviceClient_CreateFromConnectionString(connectionString, protocol);
